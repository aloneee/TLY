...
@property (nonatomic, strong) DDBackView     *backGroundView;
...
//            titleString = [_dataSource menu:self titleForItemsInRowAtIndexPath:[DOPIndexPath indexPathWithCol:i row:0 item:0]];
            titleString = (NSString *)self.initialTitles[i];
...
//        _backGroundView = [[DDBackView alloc] initWithFrame:CGRectMake(origin.x, origin.y, screenSize.width, screenSize.height)];
//        _backGroundView.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.0];
//        _backGroundView.opaque = NO;
//        
//        __block typeof(self) weakSelf = self;
//        _backGroundView.block = ^(DDBackView *backView){
//            [weakSelf backgroundTapped:nil];
//        };
