...
-(NSMutableArray *)serviceTypes{
    if (!_serviceTypes) {
        _serviceTypes = [NSMutableArray arrayWithArray:@[@"mutherfucker",
                                                         @"汽车美容",
                                                         @"汽车维修"]];
    }
...
-(NSMutableArray *)carTypes{
    if (!_carTypes) {
        _carTypes = [NSMutableArray arrayWithArray:@[@"汽车保养",
                                                     @"汽车美容",
                                                     @"汽车维修"]];
    }
    return _carTypes;
...
-(NSMutableArray *)sortTypes{
    if (!_sortTypes) {
        _sortTypes = [NSMutableArray arrayWithArray:@[@"not so fast ",
                                                      @"附近有限",
                                                      @"评分最高",
                                                      @"价格最高",
                                                      @"价格最低"]];
...
//            btn.frame = CGRectMake(btnW * i, 0, btnW, kTopBtnHeight);
            ...
            [btn handleControlEvents:UIControlEventTouchDown
