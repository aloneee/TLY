...
-(void)handleControlEvents:(UIControlEvents)controlEvents
                 withBlock:(UIControlActionBlock)actionBlock {
    ...
    [self addTarget:blockActionWrapper
